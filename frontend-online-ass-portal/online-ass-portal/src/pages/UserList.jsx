 ...
 return (
  <div className="min-h-screen bg-emerald-50 p-4 sm:p-6 lg:p-8">
    <div className="max-w-7xl mx-auto">
      ...
      {/* Message Alert */}
      {message && (
        <div className="mb-6 p-4 bg-emerald-100 border-l-4 border-emerald-600 rounded-r-lg shadow-md">
              ...
              {users.length > 0 ? (
                users.map((user, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                      <div className="text-xs sm:text-sm text-gray-700">{user.email}</div>
                    </td>
                    <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                      <span className="px-2 sm:px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-emerald-100 text-emerald-800">
                        {user.role}
                      </span>
                    </td>
                    <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                    ...
                    <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-center">
                      <button
                        ...
                        className="inline-flex items-center px-3 sm:px-4 py-2 bg-red-600 text-white text-xs sm:text-sm font-semibold rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200 shadow-sm hover:shadow-md"
                      >
                        Delete
                      </button>
                    </td>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm sm:text-base text-emerald-600">
          Total Users: <span className="font-bold text-emerald-800">{users.length}</span>
        </p>
      </div>
    </div>
  </div>
